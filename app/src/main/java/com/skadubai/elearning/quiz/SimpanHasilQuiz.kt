...
import com.skadubai.elearning.model.ModelNilai
...
class SimpanHasilQuiz : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_simpan_hasil_quiz)
        ...
        val btnsimpan = findViewById<LinearLayout>(R.id.btnselesai)
        ...
        btnsimpan.setOnClickListener {
            ...
            RetrofitClient.instance.SimpanNilai(
                NISN,
                id_quiz,
                Nilai.text.toString()
            ).enqueue(object : Callback<ModelNilai>{
                override fun onResponse(call: Call<ModelNilai>, response: Response<ModelNilai>) {
                    if (response.isSuccessful){
                        Log.d("Nilai Anda : ", Nilai.text.toString())
                        val kembali = Intent(this@SimpanHasilQuiz, DetailQuiz::class.java)
                            .putExtra("NISN", NISN)
                ...
                override fun onFailure(call: Call<ModelNilai>, t: Throwable) {
